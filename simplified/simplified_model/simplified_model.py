...
class SharedParameters:
    ...
    def __init__(self, n_simulations=300, n_positions=20, n_prices=10, p_min=1, p_max=2, t_max=100):
...
class Parameters(SharedParameters):

    def __init__(self, r=0.5, seed=0, init_move_firm=0, **kwargs):
...
def main():
    ...
    param = Parameters(n_positions=100, n_prices=50, t_max=100, r=0.5, init_move_firm=51)
